...
function TrackListPaging({currentPage, totalPage, handleBigPrevious, handlePrevious, handleNext, handleBigNext, changeCurrentPage}) {
...
export default TrackListPaging;